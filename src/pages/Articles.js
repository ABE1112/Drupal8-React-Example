...
class NodeList extends React.Component {
  ...
  render() {
    ...
    return (
    <table class="table-fill" style={{width: "100%", border: "1px solid black"}}>
        <caption>Articles promoted to front page</caption>
  ...
  return (
    <div style={{width: "100%"}}>
      ...
      <form onSubmit={handleSubmit}>
        <label>Title</label>
        <br />
        <input style={{width: "40%"}} type="text" onChange={e => handleChange(e, 'title')}></input>
        <br />
        <label>Body</label>
        <br />
        <textarea style={{width: "40%", padding: "50px", height: "100px"}} onChange={e => handleChange(e, 'body')}></textarea>
        <br />
